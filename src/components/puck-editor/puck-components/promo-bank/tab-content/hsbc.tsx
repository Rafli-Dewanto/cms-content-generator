...
const HsbcTabContent = () => {
  const {
    hsbc: { id, imageSource, imageAlt },
  } = bankTabs;
      ...
      <div className="border border-[#dedede] p-4">
        ...
        <div className="p-4">
          ...
          <ul className="mb-3 list-disc pl-4">
            ...
            <li className="text-sm">
              Promo berlaku untuk pembayaran menggunakan Kartu Kredit HSBC. Untuk mendapatkan promo,
            ...
            <li className="text-sm">
              Promo berlaku untuk Pre-Order di toko toko iBox dan website iBox.co.id.
            </li>
