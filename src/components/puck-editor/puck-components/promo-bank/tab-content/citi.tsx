...
const CitiTabContent = () => {
  const {
    citi: { id, imageSource, imageAlt },
  } = bankTabs;
        ...
        <div className="p-4">
          ...
          <ul className="mb-3 list-disc pl-4">
            <li className="text-sm">
              Nikmati bebas 1 bulan cicilan dengan cicilan 0% tenor 12 / 18 / 24 bulan untuk produk
              iPhone 15, iPhone 15 Plus, iPhone 15 Pro, dan iPhone 15 Pro Max.
            </li>
            <li className="text-sm">
              Promo berlaku untuk pembayaran menggunakan Kartu Kredit Citibank. Untuk mendapatkan
