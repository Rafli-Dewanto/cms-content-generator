...
const MandiriTabContent = () => {
  const {
    mandiri: { id, imageSource, imageAlt },
  } = bankTabs;
        ...
        <div className="p-4">
          ...
          <ul className="mb-3 list-disc pl-4">
            <li className="text-sm">
              Nikmati bebas 1 bulan cicilan dengan cicilan 0% tenor 18 bulan untuk produk iPhone 15
              dan iPhone 15 Plus.
            </li>
            <li className="text-sm">
              Nikmati bebas hingga 2 bulan cicilan dengan cicilan 0% tenor 24 bulan untuk produk
            ...
            <li className="text-sm">
              Promo berlaku untuk pembayaran menggunakan Kartu Kredit Bank Mandiri. Untuk
              mendapatkan promo, Konsumen wajib memilih metode pembayaran sesuai tenor cicilan promo
              yang berlaku.
            </li>
            <li className="text-sm">
          ...
          <ul className="list-disc pl-4">
            ...
            <li className="text-sm">
              Promo berlaku untuk pembayaran dengan cicilan 0% 3 / 6 / 12 / 18 / 24 bulan
              menggunakan Kartu Kredit Mandiri.
            </li>
...
export default MandiriTabContent;
